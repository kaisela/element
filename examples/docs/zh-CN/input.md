...
::: demo
```html
<el-input v-model="input" placeholder="请输入内容" :maxlength='4' ></el-input>
...
<script>
  export default {
    ...
    methods: {
      ...
      loadAll() {
        return [
          { "value": "三全鲜食（北新泾店）<em>00000</em>", "address": "长宁区新渔路144号" },
          { "value": "Hot honey 首尔炸鸡（仙霞路）", "address": "上海市长宁区淞虹路661号" },
          { "value": "新旺角茶餐厅", "address": "上海市普陀区真北路988号创邑金沙谷6号楼113" },
          { "value": "泷千家(天山西路店)", "address": "天山西路438号" },
          { "value": "胖仙女纸杯蛋糕（上海凌空店）", "address": "上海市长宁区金钟路968号1幢18号楼一层商铺18-101" },
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      loadAll() {
        return [
          { "value": "三全鲜食（北新泾店）<em>0000</em>", "address": "长宁区新渔路144号" },
          { "value": "Hot honey 首尔炸鸡（仙霞路）", "address": "上海市长宁区淞虹路661号" },
          { "value": "新旺角茶餐厅", "address": "上海市普陀区真北路988号创邑金沙谷6号楼113" },
          { "value": "泷千家(天山西路店)", "address": "天山西路438号" },
          { "value": "胖仙女纸杯蛋糕（上海凌空店）", "address": "上海市长宁区金钟路968号1幢18号楼一层商铺18-101" },
...
| onhtml  | 列表项字符串是否解析为HTML | boolean  | — | false |
| isdrop  | 输入框获得焦点且值为空时，不进行查询；是否显示查无数据 | boolean  | — | false |
